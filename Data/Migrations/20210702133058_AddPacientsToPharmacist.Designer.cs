...
namespace ProiectFinal.Data.Migrations
{
    ...
    [Migration("20210702133058_AddPacientsToPharmacist")]
    partial class AddPacientsToPharmacist
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PacientProduct", b =>
                {
                    b.Property<int>("PacientsId")
                        .HasColumnType("int");

                    b.Property<int>("ProductsId")
                        .HasColumnType("int");

                    b.HasKey("PacientsId", "ProductsId");

                    b.HasIndex("ProductsId");

                    b.ToTable("PacientProduct");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProiectFinal.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PacientProduct", b =>
                {
                    b.HasOne("ProiectFinal.Models.Pacient", null)
                        .WithMany()
                        .HasForeignKey("PacientsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProiectFinal.Models.Product", null)
                        .WithMany()
